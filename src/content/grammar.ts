    ...
    lessons: [
      {
        ...
        exercises: [
          ...
          },
          {
            kind: 'truefalse',
            id: 'a1-be-tf1',
            statement: 'She are a doctor.',
            answer: false,
            explain: 'With **she**, use **is** (She is a doctor).',
          },
          {
            kind: 'truefalse',
            id: 'a1-be-tf2',
            statement: "They aren't at home.",
            answer: true,
            audio: "They aren't at home.",
            explain: "**aren't** = are not, which is correct with **they**.",
          },
          {
            kind: 'tapCloze',
            id: 'a1-be-tc1',
            ...
            options: ['am', 'is', 'are'],
            answer: 0,
            explain: 'With **I**, always use **am**.',
          },
          {
            kind: 'pickAll',
            id: 'a1-be-pa1',
            prompt: 'Tap the correct sentences.',
            options: ['He is tall.', 'We is happy.', 'You are late.', 'I are ready.'],
            correct: [0, 2],
            explain: 'It is **we are** and **I am** — never we is or I are.',
          },
          {
            kind: 'build',
            id: 'a1-be-bd1',
            words: ['She', 'is', 'not', 'my', 'sister', 'are', 'am'],
            answer: 'She is not my sister',
            explain: 'With **she** use **is**; *are* and *am* are distractors.',
          },
          {
            kind: 'trim',
            id: 'a1-be-tr1',
            ...
            remove: [1],
            explain: '**Agree** is a verb — say *I agree*, not *I am agree*.',
          },
          {
            kind: 'trim',
            id: 'a1-be-tr2',
            words: ['He', 'is', 'a', 'very', 'nice', 'a', 'person'],
            remove: [5],
            explain: 'Only one **a**: “a very nice person”.',
          },
          {
            kind: 'match',
            id: 'a1-be-mt1',
            ...
            explain: 'Contractions pull two words together with an apostrophe.',
          },
        ],
        practice: [
          {
            focus: 'Affirmative',
            ids: ['a1-be-ex1', 'a1-be-ex2', 'a1-be-ex3', 'a1-be-tc1', 'a1-be-pa1', 'a1-be-tf1'],
          },
          { focus: 'Negatives', ids: ['a1-be-tf2', 'a1-be-ex7', 'a1-be-bd1'] },
          { focus: 'Questions', ids: ['a1-be-ex4', 'a1-be-ex6'] },
          { focus: 'Contractions & fixes', ids: ['a1-be-mt1', 'a1-be-tr1', 'a1-be-tr2'] },
        ],
      },
      {
